...
import { min, max, regex } from './properties/string';
...
export class StringSchema extends Schema<string> {
  ...
  public regex(regexValue: RegExp, message: InvalidMessage = ''): this {
    this._properties.set('regex', regex(regexValue, message));
    return this;
  }

  public email(message: InvalidMessage = messages.string.email): this {
    this._properties.set('email', regex(emailRegex, message));
    return this;
  }

  public uuid(message: InvalidMessage = messages.string.uuid): this {
    this._properties.set('uuid', regex(uuidRegex, message));
    return this;
  }

  public url(message: InvalidMessage = messages.string.url): this {
    this._properties.set('url', regex(urlRegex, message));
    return this;
  }
}
